...
const FlightPathMap = ({ flight }) => {
  ...
  return (
    <div className="space-y-6 relative">
        ...
        <div className="fixed bottom-16 right-4 sm:bottom-20 sm:right-6 md:bottom-24 md:right-6 w-80 sm:w-96 h-80 sm:h-96 bg-white dark:bg-gray-800 rounded-lg shadow-2xl z-50 flex flex-col">
          ...
          <div className="flex items-center justify-between p-3 sm:p-4 border-b dark:border-gray-700">
            <div className="flex items-center space-x-2">
              ...
              <h3 className="font-semibold text-gray-900 dark:text-white text-sm sm:text-base">Flight Assistant</h3>
            </div>
            <button
      ...
      {/* Chat Modal */}
      {chatOpen && (
        <div className="fixed bottom-16 right-4 sm:bottom-24 sm:right-6 w-80 sm:w-96 h-80 sm:h-96 bg-white dark:bg-gray-800 rounded-lg shadow-2xl z-50 flex flex-col">
          {/* Chat Header */}
          <div className="flex items-center justify-between p-3 sm:p-4 border-b dark:border-gray-700">
            <div className="flex items-center space-x-2">
          ...
          <div className="flex-1 overflow-y-auto p-3 sm:p-4 space-y-3">
            ...
            {isLoading && (
              <div className="flex justify-start">
                <div className="bg-gray-100 dark:bg-gray-700 px-3 py-2 rounded-lg text-xs sm:text-sm">
          ...
          <form onSubmit={handleChatSubmit} className="p-3 sm:p-4 border-t dark:border-gray-700">
            <div className="flex space-x-2">
              <input
                ...
                className="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
                disabled={isLoading}
              />
              <button
                type="submit"
                disabled={isLoading || !userInput.trim()}
                className="bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 text-white px-3 sm:px-4 py-2 rounded-lg text-xs sm:text-sm transition-colors"
              >
                Send
              </button>
            </div>
      ...
      {chatOpen && (
        <div className="fixed bottom-16 right-4 sm:bottom-24 sm:right-6 w-80 sm:w-96 h-80 sm:h-96 bg-white dark:bg-gray-800 rounded-lg shadow-2xl z-50 flex flex-col">
          ...
          <div className="flex items-center justify-between p-3 sm:p-4 border-b dark:border-gray-700">
            <div className="flex items-center space-x-2">
              <div className="w-2.5 h-2.5 sm:w-3 sm:h-3 bg-green-500 rounded-full"></div>
              <h3 className="font-semibold text-sm sm:text-base text-gray-900 dark:text-white">Flight Assistant</h3>
            </div>
            <button
              onClick={() => setChatOpen(false)}
              className="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200"
          ...
          <div className="flex-1 overflow-y-auto p-3 sm:p-4 space-y-2 sm:space-y-3">
            ...
            {isLoading && (
              <div className="flex justify-start">
                <div className="bg-gray-100 dark:bg-gray-700 px-2.5 py-1.5 sm:px-3 sm:py-2 rounded-lg text-xs sm:text-sm">
                  <div className="flex space-x-1">
        ...
        <div className="h-64 sm:h-80 md:h-96 relative">
          ...
          >
            ...
            <Marker position={departureCoords}>
              <Popup>
                <div className="text-center">
                  <h4 className="font-semibold">{flight.route.departure.airport.code}</h4>
                  <p className="text-sm">{flight.route.departure.airport.name}</p>
            ...
            <Marker position={arrivalCoords}>
              <Popup>
                <div className="text-center">
                  <h4 className="font-semibold">{flight.route.arrival.airport.code}</h4>
                  <p className="text-sm">{flight.route.arrival.airport.name}</p>
                  <p className="text-xs text-gray-600">
